package jaber.delivery.LocationUtil;
...
import jaber.delivery.MainActivity;
...
public class LocationHelper implements PermissionUtils.PermissionResultCallback{
    ...
    {
        permissionUtils.check_permission(permissions,"تحتاج إلى إذن GPS للحصول على موقعك",1);
    }
    ...
    public boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (googleApiAvailability.isUserResolvableError(resultCode)) {
                ...
                showToast("لا يتم اعتماد هذا الجهاز.");
            }
            return false;
        }
        return true;
